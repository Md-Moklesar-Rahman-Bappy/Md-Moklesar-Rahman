    ...
    public function run(): void
    {
        ...
        $projects = [
            [
                ...
                'description' => 'An enterprise-grade dynamic portfolio builder CMS built with Laravel 12 and Bootstrap 5.3. Features include a blog CMS, analytics, and a complete admin dashboard.',
                'short_description' => 'Enterprise portfolio CMS with blog and analytics',
                'technologies' => ['Laravel 12', 'PHP 8.2', 'MySQL', 'Bootstrap 5.3', 'Alpine.js'],
                'features' => ['Blog CMS', 'Analytics dashboard', 'Media library', 'Contact management'],
