...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold mb-1">Edit Blog Post</h4>
        <p class="text-muted mb-0">Editing: {{ $post->title }}</p>
    </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                   ...
                                   x-data="{ manual: true }" @input="manual = true">
                            @error('slug')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('content') is-invalid @enderror"
                                      id="content" name="content" rows="16" required>{{ old('content', $post->content) }}</textarea>
                            @error('content')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            @if($post->og_image)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $post->og_image) }}" alt="OG Image"
                                         class="rounded" width="100%" height="120" style="object-fit:cover;">
                                    <div class="form-check mt-1">
                                        <input class="form-check-input" type="checkbox" id="remove_og_image" name="remove_og_image" value="1">
                                        <label class="form-check-label small text-danger" for="remove_og_image">Remove current image</label>
                                    </div>
                                </div>
                            @endif
                    ...
                    @if($post->featured_image)
                        <div class="mb-3">
                            ...
                            <div class="form-check mt-2">
                                ...
                                <label class="form-check-label small text-danger" for="remove_featured_image">Remove current image</label>
                            </div>
                        </div>
                    @endif
            ...
            <div class="glass-card mb-4">
                <div class="card-body">
                    ...
                    <div class="small text-muted mb-0">
                        <i class="bi bi-clock-history me-2"></i>Updated: {{ $post->updated_at->format('M d, Y') }}
                    </div>
                </div>
            </div>
