        ...
        <div class="row justify-content-center">
            <div class="col-lg-8" data-aos="fade-up">
                ...
                <div class="min-card" data-aos="fade-up" data-aos-delay="{{ $loop->index * 50 }}">
                    <p class="mb-3" style="font-size: 0.95rem; font-style: italic; color: var(--secondary);">"{{ $testimonial->review ?? '' }}"</p>
                    <div class="d-flex align-items-center">
                        @if($testimonial->profile_image)
                        <img src="{{ asset('storage/' . $testimonial->profile_image) }}" alt="" class="rounded-circle me-3" style="width: 36px; height: 36px; object-fit: cover; filter: grayscale(30%);">
                        @else
                        ...
                        @endif
                        <div>
                            <small class="fw-semibold">{{ $testimonial->client_name ?? '' }}</small>
