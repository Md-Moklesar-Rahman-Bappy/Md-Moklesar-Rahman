...
<head>
    ...
    <title>{{ $profile->full_name ?? 'Portfolio' }} | Developer</title>
    ...
    <style>
        :root {
            --dev-primary: {{ $customization->primary_color ?? '#10b981' }};
            --dev-secondary: {{ $customization->secondary_color ?? '#06b6d4' }};
            --dev-accent: {{ $customization->accent_color ?? '#f59e0b' }};
            --dev-bg: {{ $customization->background_color ?? '#0f172a' }};
            --dev-bg-alt: {{ $customization->secondary_bg_color ?? '#1e293b' }};
            --dev-text: {{ $customization->text_color ?? '#e2e8f0' }};
            --dev-heading: {{ $customization->heading_color ?? '#f8fafc' }};
            --dev-border: #334155;
...
<body>
    <nav class="dev-nav" id="mainNav">
        <div class="container">
            <div class="d-flex align-items-center justify-content-between">
                <a href="#hero" class="nav-brand">{{ $profile->full_name ?? 'dev' }}</a>
    ...
    <script>
        ...
        document.querySelectorAll('.dev-nav .nav-link').forEach(link => {
