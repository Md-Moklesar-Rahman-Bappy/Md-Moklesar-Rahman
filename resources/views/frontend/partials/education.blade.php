                        ...
                        <div class="dev-card" style="height: 100%;">
                            <div class="d-flex align-items-start gap-3">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    @if($edu->group_or_field)
                                        <p style="color: #94a3b8; font-size: 0.8rem; margin-bottom: 0.25rem;">
                                            <i class="bi bi-book me-1"></i>{{ $edu->group_or_field }}
                                        </p>
                                    @endif
                                    <span class="dev-tag">
                                        <i class="bi bi-calendar3 me-1"></i>
                                        {{ format_date($edu->start_date) }}
                                        — {{ format_date($edu->end_date) ?: 'Present' }}
                                    </span>
                                    @if($edu->result)
                                        <div class="mt-2">
                                            <span class="dev-number">{{ $edu->result }}</span>
                                        </div>
                                    @endif
                                </div>
                            </div>
