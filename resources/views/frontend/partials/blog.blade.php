                    ...
                    <div class="col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                        <div class="dev-card h-100 d-flex flex-column">
                            ...
                            <h5 style="color: var(--dev-heading); font-size: 1rem;">
                                <a href="{{ route('home.blog.show', $post->slug) }}" style="color: var(--dev-heading);">
                                    {{ $post->title }}
                                </a>
                            </h5>
                            ...
                            <a href="{{ route('home.blog.show', $post->slug) }}" class="dev-btn mt-auto" style="font-size: 0.75rem; padding: 0.5rem 1rem; width: fit-content;">
