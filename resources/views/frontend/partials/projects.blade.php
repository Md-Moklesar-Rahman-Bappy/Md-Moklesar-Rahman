                    ...
                    <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                        <div class="dev-card h-100 d-flex flex-column">
                            ...
                            <h5 style="color: var(--dev-heading); font-size: 1rem;">
                                <a href="{{ route('home.project', $project->slug) }}" style="color: var(--dev-heading);">{{ $project->title }}</a>
                            </h5>
                            ...
                            <div class="d-flex gap-2 mt-auto">
                                @if($project->live_url)
                                    <a href="{{ $project->live_url }}" target="_blank" class="dev-btn dev-btn-filled" style="font-size: 0.75rem; padding: 0.5rem 1rem;">
                                        <i class="bi bi-box-arrow-up-right"></i> Live
                                    </a>
                                @endif
                                @if($project->github_url)
                                    <a href="{{ $project->github_url }}" target="_blank" class="dev-btn" style="font-size: 0.75rem; padding: 0.5rem 1rem;">
